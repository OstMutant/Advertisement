...
const { selectListingType } = require('./advertisement.flow');
...
async function createAdvertisementBulk(page, { title, description, category = null, city = null, listingType = null }) {
