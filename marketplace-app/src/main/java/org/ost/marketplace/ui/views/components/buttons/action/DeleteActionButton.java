...
public class DeleteActionButton extends BaseActionButton {
    ...
    public DeleteActionButton(@NonNull String tooltip, @NonNull Runnable onClick) {
        this(tooltip, onClick, null, false);
    }

    public DeleteActionButton(@NonNull String tooltip, @NonNull Runnable onClick, String cssClassName, boolean small) {
