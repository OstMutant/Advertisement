...
public class EditActionButton extends BaseActionButton {
    ...
    public EditActionButton(@NonNull String tooltip, @NonNull Runnable onClick) {
        this(tooltip, onClick, null, false);
    }

    public EditActionButton(@NonNull String tooltip, @NonNull Runnable onClick, String cssClassName, boolean small) {
