...
public enum I18nKey {
    ...
    // === Category Overlay ===
    CATEGORY_OVERLAY_TITLE_NEW("category.overlay.title.new"),
    CATEGORY_OVERLAY_TITLE_EDIT("category.overlay.title.edit"),
    CATEGORY_ACTIVITY_BUTTON("category.activity.button"),
    CATEGORY_OVERLAY_LOCALE_TAB_EN("category.overlay.locale.tab.en"),
    CATEGORY_OVERLAY_LOCALE_TAB_UK("category.overlay.locale.tab.uk"),
    CATEGORY_OVERLAY_FIELD_NAME("category.overlay.field.name"),
    CATEGORY_OVERLAY_FIELD_NAME_PLACEHOLDER("category.overlay.field.name.placeholder"),
    CATEGORY_OVERLAY_FIELD_DESCRIPTION("category.overlay.field.description"),
    CATEGORY_OVERLAY_FIELD_DESCRIPTION_PLACEHOLDER("category.overlay.field.description.placeholder"),
    CATEGORY_OVERLAY_SECTION_LABEL("category.overlay.section.label"),
    CATEGORY_OVERLAY_VALIDATION_NAME_REQUIRED("category.overlay.validation.name.required"),
    CATEGORY_OVERLAY_VALIDATION_NAME_LENGTH("category.overlay.validation.name.length"),
    CATEGORY_OVERLAY_VALIDATION_DESCRIPTION_REQUIRED("category.overlay.validation.description.required"),
    CATEGORY_OVERLAY_VALIDATION_DESCRIPTION_LENGTH("category.overlay.validation.description.length"),
    CATEGORY_OVERLAY_NOTIFICATION_SUCCESS("category.overlay.notification.success"),
    CATEGORY_OVERLAY_NOTIFICATION_VALIDATION_FAILED("category.overlay.notification.validation.failed"),
    CATEGORY_OVERLAY_NOTIFICATION_SAVE_ERROR("category.overlay.notification.save.error"),
    CATEGORY_OVERLAY_NOTIFICATION_CONFLICT("category.overlay.notification.conflict"),
    CATEGORY_OVERLAY_BUTTON_SAVE("category.overlay.button.save"),
    CATEGORY_OVERLAY_BUTTON_CANCEL("category.overlay.button.cancel"),

    // === Category Management ===
    CATEGORY_VIEW_CONFIRM_DELETE_TITLE("category.view.confirm.delete.title"),
    CATEGORY_VIEW_CONFIRM_DELETE_TEXT("category.view.confirm.delete.text"),
    CATEGORY_VIEW_CONFIRM_DELETE_BUTTON("category.view.confirm.delete.button"),
    CATEGORY_VIEW_CONFIRM_CANCEL_BUTTON("category.view.confirm.cancel.button"),
    CATEGORY_VIEW_NOTIFICATION_DELETED("category.view.notification.deleted"),
    CATEGORY_VIEW_NOTIFICATION_DELETE_ERROR("category.view.notification.delete.error"),
    CATEGORY_VIEW_NOTIFICATION_RESTORED("category.view.notification.restored"),
    CATEGORY_VIEW_TOOLTIP_EDIT("category.view.tooltip.edit"),
    CATEGORY_VIEW_TOOLTIP_DELETE("category.view.tooltip.delete"),
    CATEGORY_VIEW_TOOLTIP_RESTORE("category.view.tooltip.restore"),
    CATEGORY_VIEW_DELETED_LABEL("category.view.deleted.label"),
    CATEGORY_VIEW_EMPTY("category.view.empty"),
    CATEGORY_VIEW_BUTTON_EDIT("category.view.button.edit"),
