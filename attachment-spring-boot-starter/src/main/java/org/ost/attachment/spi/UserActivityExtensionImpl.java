...
public class UserActivityExtensionImpl implements UserActivityExtension {
    ...
    private static final String QUERY =
            ...
            " FROM " + PhotoSnapshotProjection.SOURCE +
        ...
        return jdbcClient.sql(QUERY)
                ...
                .query((rs, row) -> {
                    List<ChangeEntry> changes = photoSnapshotService.parsePhotoChanges(
                            rs.getString(PhotoSnapshotProjection.Write.CHANGES_SUMMARY));
                    return new ActivityItemDto(
                            rs.getLong("id"),
                            rs.getLong(PhotoSnapshotProjection.Write.ADVERTISEMENT_ID),
                            "ADVERTISEMENT",
                            ...
                            changes,
                            rs.getLong(PhotoSnapshotProjection.Write.CHANGED_BY_USER_ID),
