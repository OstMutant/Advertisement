...
|---|---|---|---|
| Top | 🔵 | 173 | improvement-173 (filed 2026-08-26) — infra housekeeping: audit `.claude/skills/README.md`/`.claude/commands/README.md` against live SKILL.md/command descriptions for drift, re-verify `improvement-160`'s already-`done` coverage-map rows (D3-3/D3-8/D5-7), and implement the researched-but-unbuilt SonarQube/Dagu MCP server integrations (D2-2/D2-3/D2-4) via a new project-scoped `.mcp.json` |
