...
**Type:** improvement — dependency maintenance. Migrated from the remainder of `backlog/process-
...
- `backlog/process-improvements.md` Part 1, item 2 — source item; the owasp-sanitizer portion is
  already done (see `backlog/completed/issues/` — was bundled with the tag-spam validator fix,
