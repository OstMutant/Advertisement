...
- A `/feature <name>` skill that scaffolds a new `backlog/<name>/SPEC.md` from that template,
...
- `backlog/entity-extensions/SPEC.md` — one example of the SPEC shape this issue formalizes.
