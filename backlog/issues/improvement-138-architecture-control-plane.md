...
**When:** **Track A** — done (see `completed/issues/improvement-138-architecture-control-plane-track-a.md`).
...
2. `improvement-135` keeps items 1/2/4 (fully done) and the "2,3,4 — consolidated" preface
   ...
   issues/` — fully closed, since everything remaining in it is done.
3. Track A's already-archived execution history
   (`completed/issues/improvement-138-architecture-control-plane-track-a.md`) stays a separate
...
[`completed/issues/improvement-135-ai-nav-layer-validation-and-adr-index-ci-check.md`](../completed/issues/improvement-135-ai-nav-layer-validation-and-adr-index-ci-check.md).
...
## Planned — split Track A's execution history out to `completed/issues/` (2026-08-28)
...
move the done part into `backlog/completed/issues/`.
...
1. Move the entire `## Execution outcome — Track A (2026-08-04)` section below — everything from
   ...
   verbatim into a new file, `backlog/completed/issues/improvement-138-architecture-control-plane-track-a.md`.
...
## Execution outcome — Track A (2026-08-04) — moved to `completed/issues/`
...
moved to
[`completed/issues/improvement-138-architecture-control-plane-track-a.md`](../completed/issues/improvement-138-architecture-control-plane-track-a.md)
