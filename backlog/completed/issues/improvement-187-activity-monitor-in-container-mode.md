...
- `/app` (the git repo) **is** shared — both sides mount the same Windows `D:\Ost\dev\Advertisement`
  ...
  [anthropics/claude-code#28015](https://github.com/anthropics/claude-code/issues/28015)): content
...
- [anthropics/claude-code#28015](https://github.com/anthropics/claude-code/issues/28015) — the
