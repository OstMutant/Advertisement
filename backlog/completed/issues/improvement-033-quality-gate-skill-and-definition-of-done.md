...
architectural), and the issue file is moved to `backlog/completed/issues/` — codifying practices
this project already follows informally into one written checklist.

## Related

- `backlog/process-improvements.md` Part 2, item 10 — source item, now superseded by this issue.
- `backlog/completed/issues/improvement-027-unit-testcontainers-test-layer.md`,
