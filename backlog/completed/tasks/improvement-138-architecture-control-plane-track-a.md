...
`backlog/tasks/improvement-138-architecture-control-plane.md` on 2026-08-28 per explicit user
...
issue stays open in `backlog/tasks/` (not moved to `completed/`) until Track B is resolved one way
or the other.
...
`backlog/` has no `DECISIONS.md` of its own (confirmed directly — only `BACKLOG.md`, `tasks/`,
