...
work: `backlog/tasks/improvement-150-marketplace-app-zero-deps-except-orchestrator.md`, ranked
...
- `backlog/tasks/improvement-150-marketplace-app-zero-deps-except-orchestrator.md` — direct
...
- `backlog/completed/tasks/improvement-147-marketplace-orchestrator-followups.md` — the migration
  whose effect on these two diagrams triggered this investigation.
- `backlog/tasks/improvement-148-reverify-optional-module-removal-after-bff-migration.md` — Point
