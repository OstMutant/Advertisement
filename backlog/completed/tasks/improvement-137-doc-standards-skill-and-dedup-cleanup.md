...
optimizing an ADR for brevity over completeness is the wrong trade) and `backlog/tasks/*.md`
...
At execution time: file `backlog/tasks/improvement-<next-free-number>-deep-review-missing-provider-profile-module.md`
