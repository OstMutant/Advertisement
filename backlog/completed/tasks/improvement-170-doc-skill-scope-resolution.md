...
mentions in tasks/decisions about other work, not current-state documentation this repo's citation
rules govern.
...
a direct citation of `backlog/completed/tasks/improvement-044-...md`, a real violation of the
