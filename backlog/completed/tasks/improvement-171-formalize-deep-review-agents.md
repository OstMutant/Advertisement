...
- `backlog/completed/tasks/improvement-169-hybrid-agentic-review-factory.md` — the investigation
...
`backlog/tasks/*.md` file itself (it had `Write` in `tools:`). Caught before any live run
