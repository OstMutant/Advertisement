...
- **done (2026-08-21)** — a real run on the user's machine hit
  ...
  [docker/for-win#12995](https://github.com/docker/for-win/tasks/12995),
  [microsoft/WSL#10667](https://github.com/microsoft/WSL/tasks/10667) ("environment will
  completely hang for a number of seconds then continue working"),
  [docker/for-win#14852](https://github.com/docker/for-win/tasks/14852). `run-all-tests.sh` is
