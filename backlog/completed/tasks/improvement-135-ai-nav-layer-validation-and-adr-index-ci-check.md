...
- **Aggregation trigger:** `/sync-docs --full-audit` Step A5 (new) — greps `backlog/completed/
  tasks/` (+ in-progress `backlog/tasks/`) for `## Operational notes` blocks accumulated since
...
[`improvement-138`](../../tasks/improvement-138-architecture-control-plane.md)'s "Absorbed from
...
- `backlog/completed/tasks/improvement-134-ai-navigation-context-efficiency-layer.md` — the
  original spec/build.
