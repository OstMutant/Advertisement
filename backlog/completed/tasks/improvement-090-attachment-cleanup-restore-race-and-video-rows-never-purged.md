...
- `backlog/completed/tasks/improvement-049-taxon-attachment-incomplete-rollback-bugs.md` item 4 —
  established the deliberate non-transactional ordering this issue must preserve.
- `backlog/tasks/improvement-021-attachment-concurrency-and-batching.md` — the broader
