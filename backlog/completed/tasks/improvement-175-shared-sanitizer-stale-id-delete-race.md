...
**5. Issue lifecycle:** move this file to `backlog/completed/tasks/`, drop its `BACKLOG.md` row,
...
- Step 4a/4c's Sonar stage failed its Quality Gate both times, exclusively on `new_coverage=0.0%`
  ...
  (`backlog/tasks/improvement-114-sonar-jacoco-coverage-not-wired.md` — JaCoCo never wired into
