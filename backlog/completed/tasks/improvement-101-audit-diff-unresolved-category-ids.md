...
- `backlog/completed/tasks/improvement-058-taxon-assignment-audit-trail-missing.md` /
  `marketplace-app/DECISIONS.md` ADR-019 — the read-time resolution design this issue polishes.
- `backlog/tasks/improvement-008-deleted-category-strikethrough.md` — the view-overlay analog
