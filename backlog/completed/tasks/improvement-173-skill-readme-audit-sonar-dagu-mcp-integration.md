...
**Module:** `.claude/skills/README.md`, `.claude/commands/README.md`, candidate new `.mcp.json`
  ...
  `backlog/tasks/improvement-160-certification-coverage-map.md` (D2-2/D2-3/D2-4/D2-5,
  D3-3/D3-8/D5-7 rows)
**Priority:** high (Top)
...
3. **SonarQube MCP server (D2-2) — done (2026-08-26):** `.mcp.json` added at the repo root
   ...
   - **Redesigned (2026-08-26) — session-wide `.mcp.json` replaced by an agent-scoped inline
     ...
     quality-gate/tasks/metrics, returns a structured report to whichever context dispatched it —
...
- `backlog/tasks/improvement-160-certification-coverage-map.md` — D2-2/D2-3/D2-4/D2-5 (source
