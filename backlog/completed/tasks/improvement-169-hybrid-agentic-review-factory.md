...
- `backlog/tasks/improvement-167-dag-aware-agent-friendly-script-execution-contract.md` and
  `backlog/tasks/improvement-168-ai-guidance-memory-vs-canonical-rules.md` — same pattern of a
