...
4. **Item "add tests for AccessEvaluator/TaxonRepository" fully duplicates
   [improvement-045](../completed/tasks/improvement-045-critical-test-coverage-gaps.md), and is already partially
...
- **AccessEvaluator / TaxonRepository / rate-limit test coverage.** Fully owned by
  [improvement-045](../completed/tasks/improvement-045-critical-test-coverage-gaps.md) — do not duplicate tracking
  here.
...
- [improvement-045](../completed/tasks/improvement-045-critical-test-coverage-gaps.md) — owns the actual new test
