...
- `backlog/tasks/improvement-101-audit-diff-unresolved-category-ids.md` and
  [improvement-084](improvement-084-snapshot-dto-diff-field-boilerplate.md) — land first
  (Batch F).
- `backlog/tasks/improvement-104-expandactivityfields-feature-envy.md` — same batch; both
