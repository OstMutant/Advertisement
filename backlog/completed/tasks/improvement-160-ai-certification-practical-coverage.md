...
2. If not, propose a concrete, reusable implementation (not a single-use exercise) and record it
   in the companion coverage map: `backlog/tasks/improvement-160-certification-coverage-map.md`.
...
- `backlog/tasks/improvement-160-certification-coverage-map.md` — the per-point tracking file
  this issue drives.
...
and the coverage map are archived together in `completed/tasks/` as the record of what was found;
