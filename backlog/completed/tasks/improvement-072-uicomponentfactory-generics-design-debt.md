...
Not yet moved to `backlog/completed/tasks/` — pending commit (see `.claude/rules.md` Issue
Lifecycle: move happens once the fix is implemented **and committed**).

## Related

- `backlog/tasks/improvement-071-taxonformoverlaymodehandler-raw-uicomponentfactory.md` — the one
