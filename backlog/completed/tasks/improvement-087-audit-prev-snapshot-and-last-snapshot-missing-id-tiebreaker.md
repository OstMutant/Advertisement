...
- `backlog/completed/tasks/improvement-050-toctou-scalability-locale-audit-tiebreak.md` item 4 —
  the half of this fix that already shipped, including the tied-row test technique to reuse.
- `backlog/tasks/improvement-019-findtimeline-correlated-subqueries.md` — the window-function
