...
- `backlog/completed/tasks/improvement-020-security-baseline-before-public-endpoints.md` — the
  precedent; this is its service-layer counterpart.
- `backlog/tasks/improvement-073-rest-endpoint-infrastructure-test-seeding.md` — the first
...
- `backlog/tasks/improvement-171-formalize-deep-review-agents.md` — while scoping that
