...
- `backlog/completed/tasks/improvement-011-unguarded-port-injection-in-ui-components.md` — one
...
- `backlog/tasks/improvement-010-advertisements-view-refresh-error-notification.md` — the
...
- `backlog/tasks/improvement-028-minimal-ci-pipeline.md` — where these tests actually get
