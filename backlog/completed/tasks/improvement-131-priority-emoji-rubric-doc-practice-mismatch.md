...
**Module:** `.claude/commands/feature.md` (step 5), `backlog/tasks/*.md` (29 files as of this
writing).
...
actual files: of 29 files in `backlog/tasks/*.md`, **exactly 2** use an emoji in their own
...
- `backlog/tasks/improvement-130-backlog-issues-folder-rename.md` — filed in the same commit that
...
issue was filed. All 27 pre-existing open issues in `backlog/tasks/*.md` (plus `improvement-121`,
