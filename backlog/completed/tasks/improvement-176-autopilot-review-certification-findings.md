...
in its tracked `backlog/tasks/<n>.md` file. `autopilot.md` step 1 is back to the issue-file +
...
- `improvement-160` (closed, investigation archived in `completed/tasks/`) — original source of
