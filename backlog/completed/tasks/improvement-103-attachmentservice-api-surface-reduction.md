...
- `backlog/completed/tasks/improvement-093-capturemediachanges-silent-skip-without-actor.md` —
  landed 2026-07-20 (Batch B); its `orElseThrow` decision shapes the actor-parameter question here.
- `backlog/tasks/improvement-021-attachment-concurrency-and-batching.md` item C — `saveAll`
