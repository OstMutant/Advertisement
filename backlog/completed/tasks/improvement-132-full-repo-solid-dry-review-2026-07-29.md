...
`backlog/completed/tasks/` as superseded). Rather than leave two overlapping tracking documents,
...
**All batches resolved as of 2026-07-31** — A–D, F–K fixed directly; E deferred to `improvement-133` (entry 8). This issue is now closed; see `backlog/completed/tasks/`.
...
- [improvement-121](../completed/tasks/improvement-121-solid-dry-review-findings.md) — superseded
...
- [improvement-067](../completed/tasks/improvement-067-taxontranslationrepository-unbounded-in-clause.md),
  [improvement-054](../completed/tasks/improvement-054-unbounded-in-clause-taxon-assignment-attachment.md)
