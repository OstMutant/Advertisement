...
- `backlog/tasks/improvement-042-advertisement-media-denormalized-columns.md` — sibling issue,
...
- `backlog/completed/tasks/improvement-007-taxon-findbyids-and-snapshot-captureandgetid.md` —
  the pattern this issue mirrors almost exactly, just for `UserPort` instead of `TaxonPort`.
- `backlog/entity-extensions/SPEC.md` — the JSONB proposal this issue's investigation grew out
