...
- `backlog/tasks/improvement-055-ui-vaadin-template-consistency-audit.md` — consistency polish
  items collected there should be applied in whatever layout survives this pass, not before.
- `backlog/tasks/improvement-063-playwright-stability-guard-async-init-components.md` — mobile
