...
implementation. Same shape as [improvement-046](../completed/tasks/improvement-046-list-stability-under-concurrent-edits.md)
...
Raised during [improvement-050](../completed/tasks/improvement-050-toctou-scalability-locale-audit-tiebreak.md)
...
- [improvement-050](../completed/tasks/improvement-050-toctou-scalability-locale-audit-tiebreak.md)
...
- [improvement-052](improvement-052-first-admin-registration-toctou-race.md) — same
