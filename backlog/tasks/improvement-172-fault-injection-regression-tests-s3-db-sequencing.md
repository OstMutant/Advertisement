...
prevent, `backlog/completed/tasks/improvement-069-attachment-s3-move-inside-db-transaction-orphans-on-rollback.md`).
...
- `backlog/completed/tasks/improvement-069-attachment-s3-move-inside-db-transaction-orphans-on-rollback.md`
  — the original bug and fix this issue adds regression coverage for.
- `backlog/tasks/improvement-171-formalize-deep-review-agents.md` — the discussion that surfaced
