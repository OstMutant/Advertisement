# improvement-035: Service-layer seeding for Playwright spec 06 — full e2e 11 min → ~7-8 min (NOT raw SQL — see correction below)

**Type:** improvement — test performance. Migrated from `backlog/process-improvements.md` Part 1,
item 6.
**Module:** `playwright/e2e/06-seed-filter-sort-pagination.spec.js`
...
**When:** blocked on [improvement-073](../completed/tasks/improvement-073-rest-endpoint-infrastructure-test-seeding.md)
...
Spec `06-seed-filter-sort-pagination` seeds 50 users + 50 advertisements by driving the actual
...
- [improvement-073](../completed/tasks/improvement-073-rest-endpoint-infrastructure-test-seeding.md) — the REST
...
- `playwright/e2e/06-seed-filter-sort-pagination.spec.js` Test 6 (`adminEn verifies timeline`) —
