...
**Superseded by [improvement-025](../completed/tasks/improvement-025-leaf-ui-components-plain-classes.md) — do not
...
- `refresh()` shape: `UserView.java:97-122` fully compliant (two catch blocks + notification +
  ...
  [improvement-010](../completed/tasks/improvement-010-advertisements-view-refresh-error-notification.md).
...
1. **Configurable Parameters shape — do not act here.** Already resolved architecturally by
   [improvement-025](../completed/tasks/improvement-025-leaf-ui-components-plain-classes.md); re-evaluate this
...
- [improvement-010](../completed/tasks/improvement-010-advertisements-view-refresh-error-notification.md) — already
...
- [improvement-025](../completed/tasks/improvement-025-leaf-ui-components-plain-classes.md) — already resolves
...
- [improvement-026](../completed/tasks/improvement-026-duplicate-raw-buttons-instead-of-ui-button-wrappers.md) — the
