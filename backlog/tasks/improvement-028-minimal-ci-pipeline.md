...
**Priority:** ⚪ low — [improvement-059](../completed/tasks/improvement-059-local-isolated-parameterized-ci-runner.md)
...
- [improvement-059](../completed/tasks/improvement-059-local-isolated-parameterized-ci-runner.md)
  ...
  build/test steps.
- `backlog/completed/tasks/improvement-027-unit-testcontainers-test-layer.md` — the test layer this
  pipeline should actually exercise.
- `backlog/tasks/improvement-030-archunit-test-module.md` — architecture rules that become
  build-breaking tests once both land.
- `backlog/tasks/improvement-033-quality-gate-skill-and-definition-of-done.md` — the manual/local
