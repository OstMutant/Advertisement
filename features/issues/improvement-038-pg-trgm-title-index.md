...
**Type:** improvement — performance, no code changes needed. Migrated from `features/process-
...
- `features/process-improvements.md` Part 3, item 19 — source item, now superseded by this issue.
