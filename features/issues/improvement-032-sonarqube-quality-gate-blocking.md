...
**Type:** improvement — quality tooling. Migrated from `features/process-improvements.md` Part 2,
item 9.
...
- `features/process-improvements.md` Part 2, item 9 — source item, now superseded by this issue.
- `scripts/CLAUDE.md` — existing SonarQube setup and run instructions this issue makes blocking.
- `features/issues/improvement-028-minimal-ci-pipeline.md` — where this gate actually gets
  enforced on every push, not just on manual local runs.
- `features/issues/improvement-033-quality-gate-skill-and-definition-of-done.md` — the local
