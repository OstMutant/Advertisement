...
**Type:** improvement — process/tooling. Migrated and **merged** from `features/process-
...
- `features/process-improvements.md` Part 1 item 5 and Part 2 item 11 — both source items, now
  superseded by this single issue.
- `features/issues/improvement-028-minimal-ci-pipeline.md` — CI-level backstop for the same
  docs-drift problem.
