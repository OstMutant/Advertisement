...
**Type:** improvement — UX/theming. Migrated from `features/process-improvements.md` Part 3,
item 20.
...
- `features/process-improvements.md` Part 3, item 20 — source item, now superseded by this issue.
- `features/issues/improvement-037-accessibility-contrast-and-aria.md` — shares the exact same
