...
**Type:** improvement — observability. Migrated from `features/process-improvements.md` Part 3,
item 17.
...
- `features/process-improvements.md` Part 3, item 17 — source item, now superseded by this issue.
- `features/completed/issues/improvement-023-request-correlation-id-via-mdc.md` — the adjacent,
