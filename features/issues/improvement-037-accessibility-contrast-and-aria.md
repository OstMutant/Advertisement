...
**Type:** improvement — accessibility/compliance. Migrated from `features/process-improvements.md`
Part 3, item 18.
...
- `features/process-improvements.md` Part 3, item 18 — source item, now superseded by this issue.
- `features/issues/improvement-039-dark-mode-lumo-tokens.md` — shares the same CSS-tokenization
