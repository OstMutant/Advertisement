...
**Type:** improvement — build tooling. Migrated from `features/process-improvements.md` Part 2,
item 8.
**Module:** root `pom.xml`
...
- `features/process-improvements.md` Part 2, item 8 — source item, now superseded by this issue.
- `.claude/rules.md` "Module Import Rules" — the convention this plugin makes build-enforced
  instead of review-enforced.
- `features/issues/improvement-030-archunit-test-module.md` — the sibling tool for rules that
