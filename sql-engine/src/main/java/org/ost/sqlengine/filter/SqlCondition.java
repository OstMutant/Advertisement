...
public record SqlCondition<R>(
    ...
    public static SqlCondition<Timestamp> before(SqlFilterMapping filterMapping, Instant value) {
        return applyIfPresent(filterMapping, value, SqlOperator.LESS_OR_EQUAL, Timestamp::from);
    }

    public static SqlCondition<Long> after(SqlFilterMapping filterMapping, Long value) {
        return applyIfPresent(filterMapping, value, SqlOperator.GREATER_OR_EQUAL, Function.identity());
    }

    public static SqlCondition<Long> before(SqlFilterMapping filterMapping, Long value) {
