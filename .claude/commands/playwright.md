...
2. `rm -rf playwright/pw-report scripts/logs/playwright && mkdir -p scripts/logs` -- clears the
...
3. Launch Monitor tool (persistent: true) watching
...
6. Report pass/fail counts and any failures with error details (read
