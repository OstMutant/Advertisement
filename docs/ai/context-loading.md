...
| Cross-module feature | `adr-index.md` filtered to every touched module + `platform-commons`, `docs/architecture/03-bounded-contexts.md` | — |
| Architectural change (new SPI, new `*Port`/`*Hook`, schema change touching ownership/FKs) | `platform-commons/DECISIONS.md` in full, `docs/architecture/01-module-dependencies.md`, `02-spi-map.md`, `04-database-erd.md`, `ArchitectureRulesTest` | — |
