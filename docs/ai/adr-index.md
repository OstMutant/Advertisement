...
| ADR-032 (docs/architecture/scripts) | docs/architecture/scripts | Accepted |  | Every `SCRIPT_GROUP` script self-documents via a fixed 7-field header, plus a rendered `README.md` per directory — no hand-written prose describing what a script does anywhere in the tool |
