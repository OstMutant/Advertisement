...
public class AdvertisementQueryUpdatedStartDatePickerField extends QueryDatePickerField {

    public AdvertisementQueryUpdatedStartDatePickerField(I18nService i18n) {
