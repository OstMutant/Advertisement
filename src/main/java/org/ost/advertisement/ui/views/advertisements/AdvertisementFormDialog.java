...
import org.ost.advertisement.ui.views.components.factories.FieldFactory;
...
public class AdvertisementFormDialog extends GenericFormDialog<AdvertisementEditDto> {
	...
	public AdvertisementFormDialog(AdvertisementEditDto advertisement, AdvertisementService advertisementService,
		...
		TextField titleField = FieldFactory.textField(
			i18n,
			I18nKey.ADVERTISEMENT_DIALOG_FIELD_TITLE,
			I18nKey.ADVERTISEMENT_DIALOG_FIELD_TITLE,
			255,
			true
		);
		...
		TextArea descriptionField = FieldFactory.textArea(
			i18n,
			I18nKey.ADVERTISEMENT_DIALOG_FIELD_DESCRIPTION,
			I18nKey.ADVERTISEMENT_DIALOG_FIELD_DESCRIPTION,
			1000,
			true
		);
