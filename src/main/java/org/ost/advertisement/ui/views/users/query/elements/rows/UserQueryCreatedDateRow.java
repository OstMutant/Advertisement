...
import org.ost.advertisement.ui.views.users.query.elements.fields.UserQueryCreatedEndDatePickerField;
import org.ost.advertisement.ui.views.users.query.elements.fields.UserQueryCreatedStartDatePickerField;
...
public class UserQueryCreatedDateRow extends QueryDateInlineRow {
    ...
    public UserQueryCreatedDateRow(I18nService i18n,
                                   SortIcon sortIcon,
                                   UserQueryCreatedStartDatePickerField createdStartDate,
                                   UserQueryCreatedEndDatePickerField createdEndDate) {
