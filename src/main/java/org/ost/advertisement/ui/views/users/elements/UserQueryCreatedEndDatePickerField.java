...
public class UserQueryCreatedEndDatePickerField extends QueryDatePickerField {

	public UserQueryCreatedEndDatePickerField(I18nService i18n) {
		super(Parameters.builder()
			.i18n(i18n)
			.placeholderKey(USER_FILTER_CREATED_END)
			.build());
	}
}
