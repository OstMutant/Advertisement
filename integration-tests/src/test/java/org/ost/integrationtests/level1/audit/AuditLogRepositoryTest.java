package org.ost.integrationtests.level1.audit;
 ...
 * computed version number, which the "current state" badge logic (see {@code .claude/nav/adr-index.md})
 ...
 * {@code .claude/nav/adr-index.md}) — no {@code UserAutoConfiguration} needed here,
