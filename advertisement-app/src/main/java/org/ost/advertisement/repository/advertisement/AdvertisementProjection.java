...
public class AdvertisementProjection extends SqlProjection<AdvertisementInfoDto> {
    ...
    public static final SqlFieldDefinition<String>  TITLE          = str(ALIAS + ".title",          title);
    public static final SqlFieldDefinition<String>  DESCRIPTION    = str(ALIAS + ".description",    description);
    ...
    public static final SqlFieldDefinition<Instant> DELETED_AT     = instant(ALIAS + ".deleted_at", "deleted_at");
    public static final SqlFieldDefinition<String>  MAIN_IMAGE_URL = str(ALIAS + ".main_image_url", mainImageUrl);
    public static final SqlFieldDefinition<Integer> IMAGE_COUNT    = intVal(ALIAS + ".image_count",  imageCount);
    ...
    public static final class Write {
        private Write() {}
        public static final String TABLE              = AdvertisementProjection.TABLE;
        public static final String DELETED_AT         = AdvertisementProjection.DELETED_AT.columnName();
        public static final String DELETED_BY_USER_ID = "deleted_by_user_id";
        public static final String MAIN_IMAGE_URL     = AdvertisementProjection.MAIN_IMAGE_URL.columnName();
        public static final String IMAGE_COUNT        = AdvertisementProjection.IMAGE_COUNT.columnName();
    }
